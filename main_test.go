...
func TestExecuteContract(t *testing.T) {
	...
	param, err := NewExecuteContractParam("1", "8000000", "0", "testA", abis, []interface{}{399})
	if err != nil {
		t.Log(err)
		return
	}
...
func TestQueryContract(t *testing.T) {
	...
	result, code, err := client.QueryContract(superPriv, superAddr, contractAddress, "_owner", abis, []interface{}{})
